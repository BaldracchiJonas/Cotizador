...
$(document).ready(function () {
    ...
    $("#btn_fin_step1").click(function () {
        ...
        $.post('cotizadorWs_new.php', datosEnviados, function (data) {
            ...
            saveDataStep2();
            $('.poliza_opcion_container[data-poliza="OPCION 1"]').click();
            $('.container_cargando').css('display', 'none');
            saveAPI();
        });
    });
    ...
    //18/8 show datos personales whit fade
    $('#cotVersion').on('change', function () {
