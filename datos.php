...
<div id="page_datos" class="page_body">
  <div class="section_datos">
    <div class="section_title_container">
      <i class="icono_custom car"></i> <!-- icono auto -->
  ...
  <div class="section_row" style="align-items: center; margin-bottom: 35px;">
    <div id="captcha2"></div>
  </div>
  <div class="section_row">
    <input id="btn_fin_step1" type="button" class="button_red" value="!VER MI COTIZACION!">
  </div>
</div>