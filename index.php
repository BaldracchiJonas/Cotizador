...
<body>
  ...
  <div>  
    ...
    <div class="contener_imagen">
      <img src="img\stopcar.png" class="header_imagen" alt="">
        <div class="cotiza_text">
          <div>COTIZÁ TU VEHÍCULO</div>
          <div>EN TRES PASOS.</div>
           
      <div class="calcular_text">Calculá el precio de tu seguro</div>
  ...
  <div class="page_body_container">
    <div class="container_cargando">
      <img class="imagen_cargando" src="img/spinner.gif" alt="">
    </div>
    <!-- Inicio Nav -->
    <div class="prueba">
    ...
    <nav class="nav_opcion_container">
      <div id="opcion_datos" class="nav_opcion select">
        ...
        <div class="nav_opcion_text">
          <span class="nav_opcion_number"><div class="circle" id="numero1">1</div></span> <p id="datos_veh"> &nbsp DATOS DE TU VEHICULO.</p>
        </div>
      </div>
